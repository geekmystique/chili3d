...
/**
 * Re-picks the mirror plane of an existing PlacementNode created by Mirror,
 ...
 * entry. Reuses Mirror's own step flow and transform computation entirely -
...
export class PlacementMirrorEditCommand extends Mirror {
