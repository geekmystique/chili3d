...
/**
 * Re-drags the rotation of an existing PlacementNode created by Rotate,
 ...
 * entry. Reuses Rotate's own step flow and transform computation entirely -
...
export class PlacementRotateEditCommand extends Rotate {
