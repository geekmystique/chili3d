...
import { PlacementMirrorEditCommand } from "../../../src/commands/modify/placementMirrorEdit";
import {
    ensureGlobalStubApp,
    mockShape,
    pointStepResult,
...
function buildEditCommand() {
    const cmd = new PlacementMirrorEditCommand();
...
describe("PlacementMirrorEditCommand", () => {
    let restoreTx: () => void;
    beforeEach(() => {
    ...
    test("should have command metadata", () => {
        const data = (PlacementMirrorEditCommand as any).prototype.data;
        expect(data.key).toBe("modify.placementMirrorEdit");
