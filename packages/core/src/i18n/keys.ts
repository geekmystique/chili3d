...
export const I18N_KEYS = [
    ...
    "command.modify.booleanEdit",
    "command.modify.chamfer",
    "command.modify.compoundEdit",
    "command.modify.copySubShapeEdit",
    "command.modify.curveProjectionEdit",
    "command.modify.deleteNode",
    "command.modify.edgeCornerEdit",
    "command.modify.explode",
    "command.modify.extend",
    "command.modify.extrudeEdit",
    "command.modify.faceEdit",
    "command.modify.fillet",
    "command.modify.loftEdit",
    "command.modify.mirror",
    "command.modify.move",
    "command.modify.offsetEdit",
    "command.modify.paintBucket",
    "command.modify.placementMirrorEdit",
    "command.modify.placementMoveEdit",
    "command.modify.placementRotateEdit",
    "command.modify.removeFeature",
    "command.modify.removeShapes",
    "command.modify.revolveEdit",
    "command.modify.rotate",
    "command.modify.sectionEdit",
    "command.modify.sew",
    "command.modify.shell",
    "command.modify.shellEdit",
    "command.modify.repairShape",
    "command.modify.simplifyShape",
    "command.modify.checkShape",
    "command.modify.solidEdit",
    "command.modify.split",
    "command.modify.sweepEdit",
    "command.modify.thickSolidEdit",
    "command.modify.trim",
    "command.modify.wireEdit",
